export default function TopBar() {
  return (
    <div className="flex items-center h-12 bg-[#f0f0f0] border-b border-[#e0e0e0] select-none">
      {/* Left: Teams logo */}
      ...
      <div className="flex-1 flex justify-center px-4">
        <div className="flex items-center gap-2 bg-white rounded-[4px] px-3.5 py-[5px] w-[520px] max-w-[50%] border border-[#d1d1d1]">
      ...
      <div className="flex items-center gap-0 pr-0">
        {/* Three-dot menu */}
        <button className="w-[46px] h-12 flex items-center justify-center text-[#616161] hover:bg-[#e0e0e0] transition-colors">
        ...
        <div className="flex items-center h-12">
          ...
          <button className="w-[46px] h-12 flex items-center justify-center text-[#616161] hover:bg-[#C42B1C] hover:text-white transition-colors">
            <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
